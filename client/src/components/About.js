    ...
    <section className="p-5" id="about">
      <div className="about-container row">
        <div className="about-text col-7">
          ...
          <p className="p1">I&apos;m now actively looking for an opportunity to prove myself as a hardworking and enthusiastic member of a development team, who is eager to develop their skills at every chance. More specifically, I&apos;m looking for a role as a full stack, back end or front end engineer.  Some of my interests include mathematics, cryptography, Bitcoin and finance.
          </p>
        </div>
