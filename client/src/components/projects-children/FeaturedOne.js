    ...
    <section id="featured-one">
      <div className="featured-container">
        ...
        <div className="featured-info">
          ...
          <p className="info-card p1 p-2">Driven by my interest in cryptography, I built this full stack web app that allows users to browse and enrol on cryptography courses.  I completed this project as part of the Software Engineering Immersive course run by General Assembly.</p>
          <ul className="p1 project-tech">
          ...
          <a href="https://github.com/tigeryant/sei-project-four-be" className="icon-link" target="_blank" rel="noreferrer"><i className="bi bi-github"></i></a>
        </div>
